...
var audioStart = new Audio('John_Williams_Star_Wars.mp3');
var audioError = new Audio('Darth Vader NO!.mp3');
var audioTada = new Audio('R2D2c.wav');
...
function verify() {
    ...
    if (answer != '') {
        ...
        if (answer == special_words[cont_correctAnswer]) {
            ...
            div_verifiedAnswer.innerHTML = ' <img src="StarWars3.gif" style="height: 150px;" > >';
            audioTada.play()
            cont_correctAnswer++;
        }
        else {
            div_verifiedAnswer.classList.add('wrongAnswer');
            div_verifiedAnswer.innerHTML = ' <img src="darth-vader-star-wars.gif" style="height: 100px;" >>';
