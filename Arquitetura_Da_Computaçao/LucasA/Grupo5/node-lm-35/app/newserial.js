...
class ArduinoRead {
    ...
    fake_data() {
        setInterval(() => {
            let data_float = sensors.lm35(18,40);
            let data_float2 = sensors.dht11();
            ...
            if (this.listData2.length === 59) {
                let sum = this.listData2.reduce((a, b) => a + b, 0);
...
module.exports.ArduinoDataTemp2 = { }
